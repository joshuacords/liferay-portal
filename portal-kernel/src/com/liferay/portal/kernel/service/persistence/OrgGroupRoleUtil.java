...
public class OrgGroupRoleUtil {
	 ...
	 */
	public static Map<Serializable, OrgGroupRole> fetchByPrimaryKeys(
	 ...
	 */
	public static OrgGroupRole update(
		OrgGroupRole orgGroupRole, ServiceContext serviceContext) {
	 ...
	 */
	public static List<OrgGroupRole> findByGroupId(
	 ...
	 */
	public static OrgGroupRole findByGroupId_First(
	 ...
	 */
	public static OrgGroupRole fetchByGroupId_First(
		long groupId, OrderByComparator<OrgGroupRole> orderByComparator) {
	 ...
	 * @throws NoSuchOrgGroupRoleException if a matching org group role could not be found
	 */
	public static OrgGroupRole findByGroupId_Last(
			long groupId, OrderByComparator<OrgGroupRole> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrgGroupRoleException {
	 ...
	 */
	public static OrgGroupRole fetchByGroupId_Last(
		long groupId, OrderByComparator<OrgGroupRole> orderByComparator) {
	...
	public static OrgGroupRole[] findByGroupId_PrevAndNext(
		...
		return getPersistence().findByGroupId_PrevAndNext(
			orgGroupRolePK, groupId, orderByComparator);
	}
	 ...
	 * @return the range of matching org group roles
	 */
	public static List<OrgGroupRole> findByRoleId(
	 ...
	 * @throws NoSuchOrgGroupRoleException if a matching org group role could not be found
	 */
	public static OrgGroupRole findByRoleId_First(
	 ...
	 * @return the first matching org group role, or <code>null</code> if a matching org group role could not be found
	 */
	public static OrgGroupRole fetchByRoleId_First(
		long roleId, OrderByComparator<OrgGroupRole> orderByComparator) {
	 ...
	 * @throws NoSuchOrgGroupRoleException if a matching org group role could not be found
	 */
	public static OrgGroupRole findByRoleId_Last(
			long roleId, OrderByComparator<OrgGroupRole> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrgGroupRoleException {
	 ...
	 * @return the last matching org group role, or <code>null</code> if a matching org group role could not be found
	 */
	public static OrgGroupRole fetchByRoleId_Last(
		long roleId, OrderByComparator<OrgGroupRole> orderByComparator) {
	...
	public static OrgGroupRole[] findByRoleId_PrevAndNext(
		...
		return getPersistence().findByRoleId_PrevAndNext(
			orgGroupRolePK, roleId, orderByComparator);
	}
