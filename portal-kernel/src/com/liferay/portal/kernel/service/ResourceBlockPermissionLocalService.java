...
public interface ResourceBlockPermissionLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.service.impl.ResourceBlockPermissionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the resource block permission local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ResourceBlockPermissionLocalServiceUtil} if injection and service tracking are not available.
	 */
