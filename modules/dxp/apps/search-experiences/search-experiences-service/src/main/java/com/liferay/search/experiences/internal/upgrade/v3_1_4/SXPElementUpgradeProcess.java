...
public class SXPElementUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		try (PreparedStatement preparedStatement =
			...
			for (String elementExternalReferenceCode :
				...
				preparedStatement.setString(1, elementExternalReferenceCode);

				preparedStatement.setString(
					2, _getElementDefinitionJSON(elementExternalReferenceCode));
	...
	private String _getElementDefinitionJSON(
		...
		return StringUtil.read(
			getClass(),
			"dependencies/" +
				StringUtil.toLowerCase(elementExternalReferenceCode) + ".txt");
	}
