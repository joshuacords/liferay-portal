...
public abstract class BaseSXPElementResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v1.0/sxp-elements/preview'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "SXPElement")}
	)
	...
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public SXPElement postSXPElementPreview(String string) throws Exception {
		return new SXPElement();
	}
