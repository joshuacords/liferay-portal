...
public class FolderResourceFactoryImpl implements FolderResource.Factory {
	...
	public FolderResource.Builder create() {
		return new FolderResource.Builder() {
			...
			@Override
			public FolderResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, FolderResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			FolderResource.class.getClassLoader(), FolderResource.class);

		try {
			Constructor<FolderResource> constructor =
				(Constructor<FolderResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		folderResource.setContextHttpServletResponse(httpServletResponse);
		folderResource.setContextUser(user);
		folderResource.setExpressionConvert(_expressionConvert);
		folderResource.setFilterParserProvider(_filterParserProvider);
		folderResource.setGroupLocalService(_groupLocalService);
		folderResource.setResourceActionLocalService(
