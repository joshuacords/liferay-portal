 ...
 */
@Component(
	property = "resource.locator.key=/commerce-bom/1.0/Area",
...
public class AreaResourceFactoryImpl implements AreaResource.Factory {
	...
	public AreaResource.Builder create() {
		return new AreaResource.Builder() {
			...
			public AreaResource build() {
				...
				return _areaResourceProxyProviderFunction.apply(
			...
			@Override
			public AreaResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, AreaResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AreaResource.class.getClassLoader(), AreaResource.class);

		try {
			Constructor<AreaResource> constructor =
				(Constructor<AreaResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, AreaResource>
		_areaResourceProxyProviderFunction = _getProxyProviderFunction();
