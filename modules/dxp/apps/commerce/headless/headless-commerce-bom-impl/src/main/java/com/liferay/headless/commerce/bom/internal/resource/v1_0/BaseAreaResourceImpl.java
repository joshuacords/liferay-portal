...
public abstract class BaseAreaResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Area")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/areas/{id}")
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<java.util.Collection<Area>, UnsafeConsumer<Area, Exception>,
	...
	protected UnsafeBiConsumer
		<java.util.Collection<Area>, UnsafeConsumer<Area, Exception>, Exception>
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseAreaResourceImpl.class);
