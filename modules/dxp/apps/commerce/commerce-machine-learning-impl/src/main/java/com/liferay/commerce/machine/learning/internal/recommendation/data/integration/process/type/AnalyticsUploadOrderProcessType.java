...
@Component(
	immediate = true,
	property = {
		"commerce.data.integration.process.type.key=" + AnalyticsUploadOrderProcessType.KEY,
		"commerce.data.integration.process.type.order=100"
	},
	service = ProcessType.class
)
public class AnalyticsUploadOrderProcessType extends BaseCommerceMLProcessType {
