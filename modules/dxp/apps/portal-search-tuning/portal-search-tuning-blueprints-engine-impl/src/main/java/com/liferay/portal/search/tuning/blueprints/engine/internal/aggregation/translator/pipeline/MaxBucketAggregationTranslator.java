...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.aggregation.pipeline.MaxBucketAggregationBodyConfigurationKeys;
...
public class MaxBucketAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		_setterHelper.setStringValue(
			jsonObject,
			MaxBucketAggregationBodyConfigurationKeys.FORMAT.getJsonKey(),
