...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.aggregation.bucket.MissingAggregationBodyConfigurationKeys;
...
public class MissingAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		if (!BlueprintJSONValidationUtil.validateRequiredFieldsPresent(
				jsonObject, messages,
				MissingAggregationBodyConfigurationKeys.FIELD.getJsonKey())) {
