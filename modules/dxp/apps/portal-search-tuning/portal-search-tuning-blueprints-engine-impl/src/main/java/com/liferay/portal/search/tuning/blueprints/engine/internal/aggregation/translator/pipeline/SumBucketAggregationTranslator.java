...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.aggregation.pipeline.SumBucketAggregationBodyConfigurationKeys;
...
public class SumBucketAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		if (!BlueprintJSONValidationUtil.validateRequiredFieldsPresent(
				jsonObject, messages,
				SumBucketAggregationBodyConfigurationKeys.BUCKETS_PATH.
					getJsonKey())) {
		...
		_setterHelper.setStringValue(
			jsonObject,
			SumBucketAggregationBodyConfigurationKeys.FORMAT.getJsonKey(),
