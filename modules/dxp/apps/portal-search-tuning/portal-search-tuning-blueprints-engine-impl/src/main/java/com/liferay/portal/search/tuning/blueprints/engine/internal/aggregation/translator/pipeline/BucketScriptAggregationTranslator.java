...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.aggregation.pipeline.BucketScriptAggregationBodyConfigurationKeys;
...
public class BucketScriptAggregationTranslator
	...
	public Optional<AggregationWrapper> translate(
		...
		if (!BlueprintJSONValidationUtil.validateRequiredFieldsPresent(
				jsonObject, messages,
				BucketScriptAggregationBodyConfigurationKeys.BUCKETS_PATH.
					getJsonKey(),
