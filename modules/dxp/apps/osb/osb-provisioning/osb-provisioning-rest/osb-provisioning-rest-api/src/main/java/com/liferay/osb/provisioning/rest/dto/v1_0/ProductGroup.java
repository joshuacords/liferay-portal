 ...
 */
@Generated("")
@GraphQLName(description = "The top level of products", value = "ProductGroup")
...
public class ProductGroup implements Serializable {
	...
	@GraphQLField(description = "The name of the product group.")
	...
	@Schema(
		...
		defaultValue = "com.liferay.osb.provisioning.rest.dto.v1_0.ProductGroup",
		name = "x-class-name"
	)
