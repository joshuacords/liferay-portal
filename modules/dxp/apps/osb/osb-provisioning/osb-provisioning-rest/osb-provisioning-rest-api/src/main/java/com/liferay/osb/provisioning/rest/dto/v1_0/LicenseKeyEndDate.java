...
@GraphQLName(
	...
	value = "LicenseKeyEndDate"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "LicenseKeyEndDate")
public class LicenseKeyEndDate implements Serializable {

	public static LicenseKeyEndDate toDTO(String json) {
		return ObjectMapperUtil.readValue(LicenseKeyEndDate.class, json);
	}

	public static LicenseKeyEndDate unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(LicenseKeyEndDate.class, json);
	}

	@Schema(description = "The date the license key ends.")
	...
	@GraphQLField(description = "The date the license key ends.")
	...
	@Schema(
		...
		defaultValue = "com.liferay.osb.provisioning.rest.dto.v1_0.LicenseKeyEndDate",
		name = "x-class-name"
	)
