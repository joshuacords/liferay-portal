 ...
 */
@Generated("")
public interface CommonLicenseKeyResource {
	...
	public void
			getAccountAccountKeyProductGroupProductGroupNameProductEnvironmentProductEnvironmentNameCommonLicenseKey(
				...
				String productEnvironmentName, java.util.Date dateEnd,
				java.util.Date dateStart)
		throws Exception;

	public HttpInvoker.HttpResponse
			getAccountAccountKeyProductGroupProductGroupNameProductEnvironmentProductEnvironmentNameCommonLicenseKeyHttpResponse(
				String accountKey, String productGroupName,
				String productEnvironmentName, java.util.Date dateEnd,
				java.util.Date dateStart)
		throws Exception;
	...
	public static class CommonLicenseKeyResourceImpl
		...
		public void
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountAccountKeyProductGroupProductGroupNameProductEnvironmentProductEnvironmentNameCommonLicenseKeyHttpResponse(
					accountKey, productGroupName, productEnvironmentName,
					dateEnd, dateStart);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path("productEnvironmentName", productEnvironmentName);
		...
		private CommonLicenseKeyResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			CommonLicenseKeyResource.class.getName());
