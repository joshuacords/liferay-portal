...
public interface AppLicenseKeyResource {
	...
	public HttpInvoker.HttpResponse getAppLicenseKeysPageHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postAppLicenseKeyHttpResponse(
			String agentName, String agentUID, AppLicenseKey appLicenseKey)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putAppLicenseKeyActivateHttpResponse(
			String agentName, String agentUID, Long[] appLicenseKeyIds)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putAppLicenseKeyDeactivateHttpResponse(
			String agentName, String agentUID, Long[] appLicenseKeyIds)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getAppLicenseKeyHttpResponse(
			Long appLicenseKeyId)
		throws Exception;

	public void getAppLicenseKeyDownload(Long appLicenseKeyId) throws Exception;

	public HttpInvoker.HttpResponse getAppLicenseKeyDownloadHttpResponse(
			Long appLicenseKeyId)
		throws Exception;
	...
	public static class Builder {
		...
		public AppLicenseKeyResource build() {
			return new AppLicenseKeyResourceImpl(this);
		}
	...
	public static class AppLicenseKeyResourceImpl
		implements AppLicenseKeyResource {
		...
		public Page<AppLicenseKey> getAppLicenseKeysPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getAppLicenseKeysPageHttpResponse(
			...
			try {
				return Page.of(content, AppLicenseKeySerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public AppLicenseKey postAppLicenseKey(
			...
			try {
				return AppLicenseKeySerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postAppLicenseKeyHttpResponse(
			...
			httpInvoker.body(appLicenseKey.toString(), "application/json");
		...
		public void putAppLicenseKeyActivate(
			...
			HttpInvoker.HttpResponse httpResponse =
				putAppLicenseKeyActivateHttpResponse(
		...
		public HttpInvoker.HttpResponse putAppLicenseKeyActivateHttpResponse(
			...
			if (appLicenseKeyIds != null) {
				for (int i = 0; i < appLicenseKeyIds.length; i++) {
					httpInvoker.parameter(
						"appLicenseKeyIds",
						String.valueOf(appLicenseKeyIds[i]));
				}
			}
		...
		public void putAppLicenseKeyDeactivate(
			...
			HttpInvoker.HttpResponse httpResponse =
				putAppLicenseKeyDeactivateHttpResponse(
					agentName, agentUID, appLicenseKeyIds);
		...
		public AppLicenseKey getAppLicenseKey(Long appLicenseKeyId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getAppLicenseKeyHttpResponse(appLicenseKeyId);
		...
		public void getAppLicenseKeyDownload(Long appLicenseKeyId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getAppLicenseKeyDownloadHttpResponse(appLicenseKeyId);
		...
		private AppLicenseKeyResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AppLicenseKeyResource.class.getName());
