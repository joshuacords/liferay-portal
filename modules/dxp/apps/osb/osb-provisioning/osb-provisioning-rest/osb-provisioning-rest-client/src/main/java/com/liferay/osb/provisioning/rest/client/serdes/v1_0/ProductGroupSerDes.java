...
import com.liferay.osb.provisioning.rest.client.dto.v1_0.ProductGroup;
...
public class ProductGroupSerDes {
	...
	public static Map<String, String> toMap(ProductGroup productGroup) {
		...
		if (productGroup.getName() == null) {
			...
			map.put("name", String.valueOf(productGroup.getName()));
		}
			...
			if (Objects.equals(jsonParserFieldName, "name")) {
				if (jsonParserFieldValue != null) {
					productGroup.setName(
						ProductGroup.Name.create((String)jsonParserFieldValue));
				}
			}
		}
