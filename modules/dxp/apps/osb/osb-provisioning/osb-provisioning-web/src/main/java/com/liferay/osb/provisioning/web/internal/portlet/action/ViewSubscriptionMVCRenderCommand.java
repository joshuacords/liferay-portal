...
@Component(
	property = {
		...
		"mvc.command.name=/accounts/view_subscription"
	},
	service = MVCRenderCommand.class
)
public class ViewSubscriptionMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		try {
			...
			renderRequest.setAttribute(
				ProvisioningWebKeys.PRODUCT_PURCHASE_VIEW, productPurchaseView);

			return "/accounts/view_subscription.jsp";
		}
