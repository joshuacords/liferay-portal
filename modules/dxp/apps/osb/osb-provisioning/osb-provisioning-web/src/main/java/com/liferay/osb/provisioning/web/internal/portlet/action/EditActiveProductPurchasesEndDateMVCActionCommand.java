...
@Component(
	property = {
		...
		"mvc.command.name=/accounts/edit_active_product_purchases_end_date"
	},
	service = MVCActionCommand.class
)
public class EditActiveProductPurchasesEndDateMVCActionCommand
		...
		try {
			...
			if (exception instanceof Problem.ProblemException) {
				...
				actionResponse.setRenderParameter(
					...
					"/accounts/view_account_subscriptions");
			}
			else {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EditActiveProductPurchasesEndDateMVCActionCommand.class);
