...
/**
 * Provides the base implementation for the product bundle products local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.provisioning.service.impl.ProductBundleProductsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.provisioning.service.impl.ProductBundleProductsLocalServiceImpl
 * @generated
 */
public abstract class ProductBundleProductsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductBundleProductsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductBundleProductsLocalServiceUtil</code>.
	 */
	...
	public ProductBundleProducts addProductBundleProducts(
		...
		return productBundleProductsPersistence.update(productBundleProducts);
	}
	...
	public ProductBundleProducts createProductBundleProducts(
		...
		return productBundleProductsPersistence.create(productBundleProductsPK);
	}
	...
	public ProductBundleProducts deleteProductBundleProducts(
		...
		return productBundleProductsPersistence.remove(productBundleProducts);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProductBundleProducts.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return productBundleProductsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return productBundleProductsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProductBundleProducts fetchProductBundleProducts(
		...
		return productBundleProductsPersistence.fetchByPrimaryKey(
	...
	public ProductBundleProducts getProductBundleProducts(
		...
		return productBundleProductsPersistence.findByPrimaryKey(
			productBundleProductsPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProductBundleProducts.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return productBundleProductsLocalService.deleteProductBundleProducts(
			(ProductBundleProducts)persistedModel);
	}

	public BasePersistence<ProductBundleProducts> getBasePersistence() {
		return productBundleProductsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return productBundleProductsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProductBundleProducts> getProductBundleProductses(
		...
		return productBundleProductsPersistence.findAll(start, end);
	}
	...
	public int getProductBundleProductsesCount() {
		return productBundleProductsPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		productBundleProductsLocalService =
			(ProductBundleProductsLocalService)aopProxy;

		_setLocalServiceUtilService(productBundleProductsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductBundleProductsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				productBundleProductsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProductBundleProductsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, productBundleProductsLocalService);
		}
	...
	protected ProductBundleProductsLocalService
		productBundleProductsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProductBundleProductsLocalServiceBaseImpl.class);
