...
public class TeamRoleModelListener extends BaseAuditModelListener<TeamRole> {

	@Override
	protected TeamRole getModel(long classPK) throws PortalException {
		return _teamRoleLocalService.getTeamRole(classPK);
	}
