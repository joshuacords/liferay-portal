...
renderResponse.setTitle(LanguageUtil.get(request, "consumption"));
%>
		...
		new JSPCreationMenu(pageContext) {
			{
				addDropdownItem(
					dropdownItem -> {
						dropdownItem.setHref(renderResponse.createRenderURL(), "mvcRenderCommandName", "/edit_external_link", "redirect", PortalUtil.getCurrentURL(request), "classNameId", PortalUtil.getClassNameId(ProductConsumption.class.getName()), "classPK", productConsumption.getProductConsumptionId(), "title", LanguageUtil.get(request, "consumption"));
...
<div class="main-content-body">
	...
	<%
	List<ExternalLink> externalLinks = productConsumption.getExternalLinks();
	%>
