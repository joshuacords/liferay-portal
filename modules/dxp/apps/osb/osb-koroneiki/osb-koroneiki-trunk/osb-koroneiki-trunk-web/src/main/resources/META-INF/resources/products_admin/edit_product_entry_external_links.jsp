...
renderResponse.setTitle(productEntry.getName());
%>
		...
		new JSPCreationMenu(pageContext) {
			{
				addDropdownItem(
					dropdownItem -> {
						dropdownItem.setHref(renderResponse.createRenderURL(), "mvcRenderCommandName", "/edit_external_link", "redirect", PortalUtil.getCurrentURL(request), "classNameId", PortalUtil.getClassNameId(ProductEntry.class.getName()), "classPK", productEntry.getProductEntryId(), "title", productEntry.getName());
...
<div class="main-content-body">
	...
	<%
	List<ExternalLink> externalLinks = productEntry.getExternalLinks();
	%>
