...
package com.liferay.osb.koroneiki.trunk.web.internal.application.list;
...
public class ProductsAdminPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return TrunkPortletKeys.PRODUCTS_ADMIN;
	}

	@Override
	@Reference(
		target = "(javax.portlet.name=" + TrunkPortletKeys.PRODUCTS_ADMIN + ")",
		unbind = "-"
	)
