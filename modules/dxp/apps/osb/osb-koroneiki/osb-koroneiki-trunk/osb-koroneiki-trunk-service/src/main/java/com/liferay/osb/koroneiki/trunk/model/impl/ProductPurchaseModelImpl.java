...
public class ProductPurchaseModelImpl
	...
	public static final long PRODUCTPURCHASEKEY_COLUMN_BITMASK = 8L;
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<ProductPurchase, Object>> entry :
			...
			Object value = attributeGetterFunction.apply((ProductPurchase)this);
		...
		private static final Function<InvocationHandler, ProductPurchase>
			_escapedModelProxyProviderFunction =
				ProxyUtil.getProxyProviderFunction(
					ProductPurchase.class, ModelWrapper.class);
