...
@Generated("")
@GraphQLName(
	description = "Represents a region within a country.",
	value = "CountryRegion"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CountryRegion")
public class CountryRegion implements Serializable {
	...
	@Schema(
		...
		defaultValue = "com.liferay.osb.koroneiki.phloem.rest.dto.v1_0.CountryRegion",
		name = "x-class-name"
	)
