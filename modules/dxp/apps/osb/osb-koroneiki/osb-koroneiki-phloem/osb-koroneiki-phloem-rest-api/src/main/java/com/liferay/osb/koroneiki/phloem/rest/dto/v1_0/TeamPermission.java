 ...
 */
@Generated("")
@GraphQLName("TeamPermission")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TeamPermission")
public class TeamPermission implements Serializable {

	public static TeamPermission toDTO(String json) {
		return ObjectMapperUtil.readValue(TeamPermission.class, json);
	}

	public static TeamPermission unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(TeamPermission.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.osb.koroneiki.phloem.rest.dto.v1_0.TeamPermission",
		name = "x-class-name"
	)
