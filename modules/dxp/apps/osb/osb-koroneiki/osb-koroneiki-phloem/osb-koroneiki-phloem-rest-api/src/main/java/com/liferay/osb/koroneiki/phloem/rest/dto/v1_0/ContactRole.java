 ...
 */
@Generated("")
@GraphQLName(description = "Represents a contact role.", value = "ContactRole")
...
public class ContactRole implements Serializable {
	...
	@Schema(description = "The description of the contact role.")
	...
	@Schema(
		description = "The contact role's links to entities in external domains."
	)
	@Valid
	...
	@Schema(description = "The contact role's key.")
	...
	@Schema(description = "The name of the contact role.")
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), contactRole.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.osb.koroneiki.phloem.rest.dto.v1_0.ContactRole",
		name = "x-class-name"
	)
