 ...
 * @author Amos Fong
 */
public class ProductPurchaseEntityModel implements EntityModel {

	public static final String NAME = "ProductPurchase";

	public ProductPurchaseEntityModel(List<String> productFieldNames) {
