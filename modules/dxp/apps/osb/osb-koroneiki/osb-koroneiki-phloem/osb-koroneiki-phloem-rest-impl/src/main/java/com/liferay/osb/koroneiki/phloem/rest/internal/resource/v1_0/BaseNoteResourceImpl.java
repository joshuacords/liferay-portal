...
public abstract class BaseNoteResourceImpl implements NoteResource {
	...
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the account's notes."
	)
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Note")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/accounts/{accountKey}/notes")
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/notes/{noteKey}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the note."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseNoteResourceImpl.class);
