...
import com.liferay.osb.koroneiki.phloem.rest.client.serdes.v1_0.TeamPermissionSerDes;
 ...
 */
@Generated("")
public class TeamPermission implements Cloneable, Serializable {

	public static TeamPermission toDTO(String json) {
		return TeamPermissionSerDes.toDTO(json);
	}
	...
	public void setAssignContact(Boolean assignContact) {
		this.assignContact = assignContact;
	}

	public void setAssignContact(
		UnsafeSupplier<Boolean, Exception> assignContactUnsafeSupplier) {

		try {
			assignContact = assignContactUnsafeSupplier.get();
		}
		catch (Exception e) {
	...
	protected Boolean assignContact;
	...
	@Override
	public TeamPermission clone() throws CloneNotSupportedException {
		return (TeamPermission)super.clone();
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof TeamPermission)) {
			return false;
		}

		TeamPermission teamPermission = (TeamPermission)object;

		return Objects.equals(toString(), teamPermission.toString());
	}
	...
	public String toString() {
		return TeamPermissionSerDes.toJSON(this);
	}
