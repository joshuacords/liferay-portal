...
public class AccountPermission implements Cloneable, Serializable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof AccountPermission)) {
			return false;
		}

		AccountPermission accountPermission = (AccountPermission)object;

		return Objects.equals(toString(), accountPermission.toString());
	}
	...
	public String toString() {
		return AccountPermissionSerDes.toJSON(this);
	}
