...
import com.liferay.osb.koroneiki.phloem.rest.client.serdes.v1_0.ContactRolePermissionSerDes;
 ...
 */
@Generated("")
public class ContactRolePermission implements Cloneable, Serializable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ContactRolePermission)) {
			return false;
		}

		ContactRolePermission contactRolePermission =
			(ContactRolePermission)object;

		return Objects.equals(toString(), contactRolePermission.toString());
	}
	...
	public String toString() {
		return ContactRolePermissionSerDes.toJSON(this);
	}
