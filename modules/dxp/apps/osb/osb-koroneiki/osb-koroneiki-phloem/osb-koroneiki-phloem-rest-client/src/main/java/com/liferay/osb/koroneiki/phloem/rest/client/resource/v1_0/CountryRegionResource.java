...
public interface CountryRegionResource {
	...
	public static class Builder {
		...
		public CountryRegionResource build() {
			return new CountryRegionResourceImpl(this);
		}
	...
	public static class CountryRegionResourceImpl
		...
		public Page<CountryRegion> getCountryRegionsPage() throws Exception {
			...
			try {
				return Page.of(content, CountryRegionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/koroneiki-rest/v1.0/country-regions");
		...
		private CountryRegionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			CountryRegionResource.class.getName());
