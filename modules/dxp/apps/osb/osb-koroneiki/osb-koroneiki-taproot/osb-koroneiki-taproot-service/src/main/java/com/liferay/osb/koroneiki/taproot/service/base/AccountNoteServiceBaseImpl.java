...
/**
 * Provides the base implementation for the account note remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.AccountNoteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.AccountNoteServiceImpl
 * @generated
 */
public abstract class AccountNoteServiceBaseImpl
	extends BaseServiceImpl
	implements AccountNoteService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccountNoteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AccountNoteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccountNoteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accountNoteService = (AccountNoteService)aopProxy;

		_setServiceUtilService(accountNoteService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountNoteService.class.getName();
	}
	...
	private void _setServiceUtilService(AccountNoteService accountNoteService) {
		try {
			Field field = AccountNoteServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, accountNoteService);
		}
	...
	@Reference
	protected com.liferay.osb.koroneiki.taproot.service.AccountNoteLocalService
		accountNoteLocalService;

	protected AccountNoteService accountNoteService;
