...
/**
 * Provides the base implementation for the account note local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.AccountNoteLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.AccountNoteLocalServiceImpl
 * @generated
 */
public abstract class AccountNoteLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccountNoteLocalService, AopService, IdentifiableOSGiService {
	...
	public AccountNote createAccountNote(long accountNoteId) {
		return accountNotePersistence.create(accountNoteId);
	}
	...
	public AccountNote deleteAccountNote(long accountNoteId)
		...
		return accountNotePersistence.remove(accountNoteId);
	}
	...
	public AccountNote deleteAccountNote(AccountNote accountNote) {
		return accountNotePersistence.remove(accountNote);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccountNote.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accountNotePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return accountNotePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accountNotePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return accountNotePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AccountNote fetchAccountNote(long accountNoteId) {
		return accountNotePersistence.fetchByPrimaryKey(accountNoteId);
	}
	...
	public AccountNote fetchAccountNoteByUuidAndCompanyId(
		...
		return accountNotePersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public AccountNote getAccountNote(long accountNoteId)
		...
		return accountNotePersistence.findByPrimaryKey(accountNoteId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accountNoteLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccountNote.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accountNoteId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			accountNoteLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccountNote.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<AccountNote>() {

				@Override
				public void performAction(AccountNote accountNote)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accountNote);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return accountNoteLocalService.deleteAccountNote(
			(AccountNote)persistedModel);
	}

	public BasePersistence<AccountNote> getBasePersistence() {
		return accountNotePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return accountNotePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public AccountNote getAccountNoteByUuidAndCompanyId(
		...
		return accountNotePersistence.findByUuid_C_First(uuid, companyId, null);
	}
	...
	public List<AccountNote> getAccountNotes(int start, int end) {
		return accountNotePersistence.findAll(start, end);
	}
	...
	public int getAccountNotesCount() {
		return accountNotePersistence.countAll();
	}
	...
	protected void deactivate() {
		AccountNoteLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccountNoteLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		...
		AccountNoteLocalServiceUtil.setService(accountNoteLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccountNoteLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accountNotePersistence.getDataSource();
	...
	protected AccountNoteLocalService accountNoteLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccountNoteLocalServiceBaseImpl.class);
