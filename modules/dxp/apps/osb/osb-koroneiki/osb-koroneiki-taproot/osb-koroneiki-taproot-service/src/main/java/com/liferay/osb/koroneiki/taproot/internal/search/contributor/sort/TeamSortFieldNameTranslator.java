...
@Component(
	immediate = true,
	property = ContributorConstants.ENTRY_CLASS_NAME_PROPERTY_KEY + "=com.liferay.osb.koroneiki.taproot.model.Team",
	service = SortFieldNameTranslator.class
)
public class TeamSortFieldNameTranslator implements SortFieldNameTranslator {
