...
/**
 * Provides the base implementation for the contact team role remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.ContactTeamRoleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.ContactTeamRoleServiceImpl
 * @generated
 */
public abstract class ContactTeamRoleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ContactTeamRoleService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ContactTeamRoleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ContactTeamRoleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ContactTeamRoleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		contactTeamRoleService = (ContactTeamRoleService)aopProxy;

		_setServiceUtilService(contactTeamRoleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ContactTeamRoleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ContactTeamRoleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, contactTeamRoleService);
		}
	...
	@Reference
	protected
		com.liferay.osb.koroneiki.taproot.service.ContactTeamRoleLocalService
			contactTeamRoleLocalService;

	protected ContactTeamRoleService contactTeamRoleService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ContactTeamRoleLocalServiceBaseImpl.class);
