...
/**
 * Provides the base implementation for the team account role remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.koroneiki.taproot.service.impl.TeamAccountRoleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.osb.koroneiki.taproot.service.impl.TeamAccountRoleServiceImpl
 * @generated
 */
public abstract class TeamAccountRoleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TeamAccountRoleService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TeamAccountRoleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TeamAccountRoleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TeamAccountRoleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		teamAccountRoleService = (TeamAccountRoleService)aopProxy;

		_setServiceUtilService(teamAccountRoleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TeamAccountRoleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = TeamAccountRoleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, teamAccountRoleService);
		}
	...
	@Reference
	protected
		com.liferay.osb.koroneiki.taproot.service.TeamAccountRoleLocalService
			teamAccountRoleLocalService;

	protected TeamAccountRoleService teamAccountRoleService;
