...
public abstract class ContactRoleLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ContactRoleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ContactRoleLocalServiceUtil</code>.
	 */
	...
	public BasePersistence<ContactRole> getBasePersistence() {
		return contactRolePersistence;
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(contactRoleLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ContactRoleLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, contactRoleLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ContactRoleLocalServiceBaseImpl.class);
