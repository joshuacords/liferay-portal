...
public class AccountPersistenceImpl
	...
	public List<Account> filterFindByUuid(
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_ACCOUNT_WHERE);
		}
		else {
			sb.append(_FILTER_SQL_SELECT_ACCOUNT_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_ACCOUNT_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				sb.append(AccountModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), Account.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(_FILTER_ENTITY_ALIAS, AccountImpl.class);
			}
			else {
				sqlQuery.addEntity(_FILTER_ENTITY_TABLE, AccountImpl.class);
			}
			...
			return (List<Account>)QueryUtil.list(
	...
	protected Account filterGetByUuid_PrevAndNext(
		...
		List<Account> list = sqlQuery.list();
	...
	public int filterCountByUuid(String uuid) {
		...
		sb.append(_FILTER_SQL_COUNT_ACCOUNT_WHERE);
	...
	public List<Account> findByParentAccountId(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_PARENTACCOUNTID_PARENTACCOUNTID_2);
