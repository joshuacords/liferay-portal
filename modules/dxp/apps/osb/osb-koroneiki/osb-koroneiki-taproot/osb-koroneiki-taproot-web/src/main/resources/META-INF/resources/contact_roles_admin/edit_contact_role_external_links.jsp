...
renderResponse.setTitle(contactRole.getName());
%>
		...
		new JSPCreationMenu(pageContext) {
			{
				addDropdownItem(
					dropdownItem -> {
						dropdownItem.setHref(renderResponse.createRenderURL(), "mvcRenderCommandName", "/edit_external_link", "redirect", PortalUtil.getCurrentURL(request), "classNameId", PortalUtil.getClassNameId(ContactRole.class.getName()), "classPK", contactRole.getContactRoleId(), "title", contactRole.getName());
...
<div class="main-content-body">
	...
	<%
	List<ExternalLink> externalLinks = contactRole.getExternalLinks();
	%>
