...
/**
 * Provides the local service interface for AccountField. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccountFieldLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AccountFieldLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.osb.koroneiki.taproot.service.impl.AccountFieldLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the account field local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AccountFieldLocalServiceUtil} if injection and service tracking are not available.
	 */
