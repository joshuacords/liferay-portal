...
public interface AssigneeUserResource {
	...
	public void postProcessAssigneeUsersPageExportBatch(
			Long processId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postProcessAssigneeUsersPageExportBatchHttpResponse(
				Long processId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class AssigneeUserResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/portal-workflow-metrics/v1.0/processes/{processId}/assignee-users/export-batch");
