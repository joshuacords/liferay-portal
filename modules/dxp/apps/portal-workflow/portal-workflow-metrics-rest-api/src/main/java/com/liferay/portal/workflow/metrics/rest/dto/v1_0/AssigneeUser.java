...
@Generated("")
@GraphQLName(
	description = "https://schema.org/AssigneeUser", value = "AssigneeUser"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AssigneeUser")
public class AssigneeUser implements Serializable {

	public static AssigneeUser toDTO(String json) {
		return ObjectMapperUtil.readValue(AssigneeUser.class, json);
	}

	public static AssigneeUser unsafeToDTO(String json) {
