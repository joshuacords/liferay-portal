...
public abstract class BaseMetricResourceTestCase {
	...
	protected void assertValid(Metric metric) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(
		Page<Metric> page, Map<String, Map<String, String>> expectedActions) {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseMetricResourceTestCase.class);
