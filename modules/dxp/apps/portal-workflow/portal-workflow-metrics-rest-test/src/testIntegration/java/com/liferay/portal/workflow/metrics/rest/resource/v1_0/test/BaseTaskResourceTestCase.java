...
public abstract class BaseTaskResourceTestCase {
	...
	public void testGetProcessTasksPage() throws Exception {
		...
		page = taskResource.getProcessTasksPage(
			processId, null, null, null, null, Pagination.of(1, 10), null);
	...
	public void testGetProcessTasksPageWithSortDouble() throws Exception {
		testGetProcessTasksPageWithSort(
			...
			(entityField, task1, task2) -> {
				BeanTestUtil.setProperty(task1, entityField.getName(), 0.1);
				BeanTestUtil.setProperty(task2, entityField.getName(), 0.5);
			});
	}
	...
	public void testGetProcessTasksPageWithSortInteger() throws Exception {
		testGetProcessTasksPageWithSort(
			...
			(entityField, task1, task2) -> {
				BeanTestUtil.setProperty(task1, entityField.getName(), 0);
				BeanTestUtil.setProperty(task2, entityField.getName(), 1);
			});
	}
