...
public abstract class BaseAssigneeUserResourceTestCase {
	...
	protected void assertValid(AssigneeUser assigneeUser) throws Exception {
		boolean valid = true;
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("image")) {
			Object object = assigneeUser.getImage();
		...
		if (entityFieldName.equals("name")) {
			Object object = assigneeUser.getName();
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseAssigneeUserResourceTestCase.class);
