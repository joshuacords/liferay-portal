 ...
 * @generated
 */
@Component(service = SpringEntryPersistence.class)
public class SpringEntryPersistenceImpl
	...
	public void cacheResult(SpringEntry springEntry) {
		entityCache.putResult(
			entityCacheEnabled, SpringEntryImpl.class,
			springEntry.getPrimaryKey(), springEntry);
	...
	public void cacheResult(List<SpringEntry> springEntries) {
		...
		for (SpringEntry springEntry : springEntries) {
			if (entityCache.getResult(
					entityCacheEnabled, SpringEntryImpl.class,
					springEntry.getPrimaryKey()) == null) {
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, SpringEntryImpl.class, primaryKey);
		}
	}
	...
	public SpringEntry updateImpl(SpringEntry springEntry) {
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {springEntryModelImpl.getUuid()};
			...
			args = new Object[] {
				springEntryModelImpl.getUuid(),
				springEntryModelImpl.getCompanyId()
			};
			...
			args = new Object[] {springEntryModelImpl.getCompanyId()};
			...
			if ((springEntryModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByUuid.getColumnBitmask()) !=
					 0) {

				Object[] args = new Object[] {
					springEntryModelImpl.getOriginalUuid()
				};
				...
				args = new Object[] {springEntryModelImpl.getUuid()};
			...
			if ((springEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					springEntryModelImpl.getOriginalUuid(),
					springEntryModelImpl.getOriginalCompanyId()
				};
		...
		entityCache.putResult(
			entityCacheEnabled, SpringEntryImpl.class,
			springEntry.getPrimaryKey(), springEntry, false);
	...
	public void activate() {
		SpringEntryModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		SpringEntryModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_valueObjectFinderCacheListThreshold = GetterUtil.getInteger(
			PropsUtil.get(PropsKeys.VALUE_OBJECT_FINDER_CACHE_LIST_THRESHOLD));

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, SpringEntryImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			SpringEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			SpringEntryModelImpl.UUID_COLUMN_BITMASK |
			SpringEntryModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.portal.tools.service.builder.spring.sample.model.SpringEntry"),
			true);
	}
