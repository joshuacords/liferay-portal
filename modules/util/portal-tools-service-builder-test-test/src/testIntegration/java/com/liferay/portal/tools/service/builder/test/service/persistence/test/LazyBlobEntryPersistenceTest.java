...
public class LazyBlobEntryPersistenceTest {
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(
			existingLazyBlobEntry.getUuid(),
			ReflectionTestUtil.invoke(
				existingLazyBlobEntry, "getOriginalUuid", new Class<?>[0]));
		Assert.assertEquals(
			Long.valueOf(existingLazyBlobEntry.getGroupId()),
			ReflectionTestUtil.<Long>invoke(
				existingLazyBlobEntry, "getOriginalGroupId", new Class<?>[0]));
	}
