...
public class EagerBlobEntryPersistenceTest {
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(
			existingEagerBlobEntry.getUuid(),
			ReflectionTestUtil.invoke(
				existingEagerBlobEntry, "getOriginalUuid", new Class<?>[0]));
		Assert.assertEquals(
			Long.valueOf(existingEagerBlobEntry.getGroupId()),
			ReflectionTestUtil.<Long>invoke(
				existingEagerBlobEntry, "getOriginalGroupId", new Class<?>[0]));
	}
