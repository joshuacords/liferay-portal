...
public class RenameFinderColumnEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newRenameFinderColumnEntry.setRenamedColumn(
		...
		Assert.assertEquals(
			existingRenameFinderColumnEntry.getRenamedColumn(),
			newRenameFinderColumnEntry.getRenamedColumn());
	}
	...
	protected OrderByComparator<RenameFinderColumnEntry>
		...
		return OrderByComparatorFactoryUtil.create(
			...
			"groupId", true, "renamedColumn", true);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(
			...
			ReflectionTestUtil.invoke(
				existingRenameFinderColumnEntry, "getOriginalRenamedColumn",
				new Class<?>[0]));
	}
	...
	protected RenameFinderColumnEntry addRenameFinderColumnEntry()
		...
		renameFinderColumnEntry.setRenamedColumn(RandomTestUtil.randomString());
