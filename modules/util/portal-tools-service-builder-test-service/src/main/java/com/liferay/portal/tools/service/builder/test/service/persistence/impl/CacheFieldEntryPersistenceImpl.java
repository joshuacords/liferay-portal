...
public class CacheFieldEntryPersistenceImpl
	...
	public CacheFieldEntryPersistenceImpl() {
		...
		setEntityCacheEnabled(CacheFieldEntryModelImpl.ENTITY_CACHE_ENABLED);
	}
	...
	public void cacheResult(CacheFieldEntry cacheFieldEntry) {
		entityCache.putResult(
			CacheFieldEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public CacheFieldEntry updateImpl(CacheFieldEntry cacheFieldEntry) {
		...
		if (!CacheFieldEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {
				cacheFieldEntryModelImpl.getGroupId()
			};
			...
			if ((cacheFieldEntryModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByGroupId.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					cacheFieldEntryModelImpl.getOriginalGroupId()
				};
				...
				args = new Object[] {cacheFieldEntryModelImpl.getGroupId()};
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			CacheFieldEntryModelImpl.ENTITY_CACHE_ENABLED,
			CacheFieldEntryModelImpl.FINDER_CACHE_ENABLED,
			CacheFieldEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathCountAll = new FinderPath(
			CacheFieldEntryModelImpl.ENTITY_CACHE_ENABLED,
			CacheFieldEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithoutPaginationFindByGroupId = new FinderPath(
			...
			CacheFieldEntryModelImpl.GROUPID_COLUMN_BITMASK);
