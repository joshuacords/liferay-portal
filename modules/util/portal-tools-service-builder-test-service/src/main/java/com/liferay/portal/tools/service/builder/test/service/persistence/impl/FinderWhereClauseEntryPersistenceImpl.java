...
public class FinderWhereClauseEntryPersistenceImpl
	...
	public FinderWhereClauseEntryPersistenceImpl() {
		...
		setEntityCacheEnabled(
			FinderWhereClauseEntryModelImpl.ENTITY_CACHE_ENABLED);
	}
	...
	public void clearCache(FinderWhereClauseEntry finderWhereClauseEntry) {
		entityCache.removeResult(
			FinderWhereClauseEntryModelImpl.ENTITY_CACHE_ENABLED,
			FinderWhereClauseEntryImpl.class,
			finderWhereClauseEntry.getPrimaryKey());
	...
	public FinderWhereClauseEntry updateImpl(
		...
		if (!FinderWhereClauseEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {
				finderWhereClauseEntryModelImpl.getName()
			};
			...
			if ((finderWhereClauseEntryModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByName_Nickname.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					finderWhereClauseEntryModelImpl.getOriginalName()
				};
				...
				args = new Object[] {finderWhereClauseEntryModelImpl.getName()};
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			FinderWhereClauseEntryModelImpl.ENTITY_CACHE_ENABLED,
			FinderWhereClauseEntryModelImpl.FINDER_CACHE_ENABLED,
			FinderWhereClauseEntryImpl.class,
		...
		_finderPathCountAll = new FinderPath(
			FinderWhereClauseEntryModelImpl.ENTITY_CACHE_ENABLED,
			FinderWhereClauseEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithoutPaginationFindByName_Nickname = new FinderPath(
			...
			FinderWhereClauseEntryModelImpl.NAME_COLUMN_BITMASK);
