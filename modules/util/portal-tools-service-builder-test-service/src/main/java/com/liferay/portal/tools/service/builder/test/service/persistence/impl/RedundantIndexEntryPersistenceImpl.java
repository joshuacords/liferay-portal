...
public class RedundantIndexEntryPersistenceImpl
	...
	public RedundantIndexEntryPersistenceImpl() {
		...
		setEntityCacheEnabled(
			RedundantIndexEntryModelImpl.ENTITY_CACHE_ENABLED);
	}
	...
	public void clearCache(RedundantIndexEntry redundantIndexEntry) {
		...
		clearUniqueFindersCache(
			(RedundantIndexEntryModelImpl)redundantIndexEntry, true);
	}
	...
	public void clearCache(List<RedundantIndexEntry> redundantIndexEntries) {
		...
		for (RedundantIndexEntry redundantIndexEntry : redundantIndexEntries) {
			entityCache.removeResult(
				RedundantIndexEntryModelImpl.ENTITY_CACHE_ENABLED,
				RedundantIndexEntryImpl.class,
				redundantIndexEntry.getPrimaryKey());
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByC_N, args, redundantIndexEntryModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((redundantIndexEntryModelImpl.getColumnBitmask() &
			 _finderPathFetchByC_N.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				redundantIndexEntryModelImpl.getOriginalCompanyId(),
				redundantIndexEntryModelImpl.getOriginalName()
			};
	...
	public RedundantIndexEntry updateImpl(
		...
		if (!RedundantIndexEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
		...
		entityCache.putResult(
			RedundantIndexEntryModelImpl.ENTITY_CACHE_ENABLED,
			RedundantIndexEntryImpl.class, redundantIndexEntry.getPrimaryKey(),
			redundantIndexEntry, false);

		clearUniqueFindersCache(redundantIndexEntryModelImpl, false);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			RedundantIndexEntryModelImpl.ENTITY_CACHE_ENABLED,
			RedundantIndexEntryModelImpl.FINDER_CACHE_ENABLED,
			RedundantIndexEntryImpl.class,
		...
		_finderPathCountAll = new FinderPath(
			RedundantIndexEntryModelImpl.ENTITY_CACHE_ENABLED,
			RedundantIndexEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByC_N = new FinderPath(
			RedundantIndexEntryModelImpl.ENTITY_CACHE_ENABLED,
			RedundantIndexEntryModelImpl.FINDER_CACHE_ENABLED,
			RedundantIndexEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_N",
			new String[] {Long.class.getName(), String.class.getName()},
			RedundantIndexEntryModelImpl.COMPANYID_COLUMN_BITMASK |
			RedundantIndexEntryModelImpl.NAME_COLUMN_BITMASK);
