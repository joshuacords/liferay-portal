...
public class RenameFinderColumnEntryModelImpl
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("renamedColumn", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE =
		"create table RenameFinderColumnEntry (renameFinderColumnEntryId LONG not null primary key,groupId LONG,renamedColumn VARCHAR(75) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(
		com.liferay.portal.tools.service.builder.test.service.util.ServiceProps.
			get(
				"value.object.entity.cache.enabled.com.liferay.portal.tools.service.builder.test.model.RenameFinderColumnEntry"),
		true);

	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(
		com.liferay.portal.tools.service.builder.test.service.util.ServiceProps.
			get(
				"value.object.finder.cache.enabled.com.liferay.portal.tools.service.builder.test.model.RenameFinderColumnEntry"),
		true);

	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(
		com.liferay.portal.tools.service.builder.test.service.util.ServiceProps.
			get(
				"value.object.column.bitmask.enabled.com.liferay.portal.tools.service.builder.test.model.RenameFinderColumnEntry"),
		true);

	public static final long RENAMEDCOLUMN_COLUMN_BITMASK = 1L;
	...
	public void setRenamedColumn(String renamedColumn) {
		_columnBitmask |= RENAMEDCOLUMN_COLUMN_BITMASK;

		if (_originalRenamedColumn == null) {
			_originalRenamedColumn = _renamedColumn;
		}

		_renamedColumn = renamedColumn;
	}

	public String getOriginalRenamedColumn() {
		return GetterUtil.getString(_originalRenamedColumn);
	}
	...
	public Object clone() {
		...
		renameFinderColumnEntryImpl.setRenamedColumn(getRenamedColumn());
	...
	public CacheModel<RenameFinderColumnEntry> toCacheModel() {
		...
		renameFinderColumnEntryCacheModel.renamedColumn = getRenamedColumn();

		String renamedColumn = renameFinderColumnEntryCacheModel.renamedColumn;

		if ((renamedColumn != null) && (renamedColumn.length() == 0)) {
			renameFinderColumnEntryCacheModel.renamedColumn = null;
		}
	...
	private String _originalRenamedColumn;
