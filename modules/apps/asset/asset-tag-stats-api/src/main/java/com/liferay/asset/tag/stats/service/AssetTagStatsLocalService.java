...
public interface AssetTagStatsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.asset.tag.stats.service.impl.AssetTagStatsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the asset tag stats local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AssetTagStatsLocalServiceUtil} if injection and service tracking are not available.
	 */
