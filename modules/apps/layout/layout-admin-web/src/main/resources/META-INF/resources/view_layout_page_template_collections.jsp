		...
		var deleteCollections = function() {
			...
			if (layoutPageTemplateCollectionsFm) {
				var itemSelectorDialog = new A.LiferayItemSelectorDialog({
					...
					url:
						'<portlet:renderURL windowState="<%= LiferayWindowState.POP_UP.toString() %>"><portlet:param name="mvcRenderCommandName" value="/layout/select_layout_page_template_collections" /></portlet:renderURL>'
				});
