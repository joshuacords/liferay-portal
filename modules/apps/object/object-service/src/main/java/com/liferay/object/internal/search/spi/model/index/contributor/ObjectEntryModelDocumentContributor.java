...
public class ObjectEntryModelDocumentContributor
	...
	private void _contribute(Document document, ObjectEntry objectEntry)
		...
		String defaultObjectEntryContent = objectEntryContents.get(
			defaultLanguageId);

		if (defaultObjectEntryContent == null) {
			defaultObjectEntryContent = StringPool.BLANK;
		}

		if (objectEntryContents.isEmpty()) {
			document.add(
				new Field("objectEntryContent", defaultObjectEntryContent));
		}
		else {
			for (Map.Entry<String, String> entry :
					objectEntryContents.entrySet()) {
