...
public abstract class BaseStructuredContentResourceImpl
	...
	@javax.ws.rs.Path("/structured-content/{structuredContentId}/subscribe")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.PUT
	@Override
	...
	@javax.ws.rs.Path("/structured-content/{structuredContentId}/unsubscribe")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.PUT
	@Override
	...
	public String getStructuredContentRenderedContentTemplate(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("templateId")
			Long templateId)
		throws Exception {
		...
		if ("INSERT".equalsIgnoreCase(createStrategy)) {
			if (parameters.containsKey("structuredContentFolderId")) {
				...
				throw new NotSupportedException(
					"One of the following parameters must be specified: [structuredContentFolderId, siteId]");
			}
		}
	...
	public Page<StructuredContent> read(
		...
		if (parameters.containsKey("siteId")) {
			...
			throw new NotSupportedException(
				"One of the following parameters must be specified: [siteId, contentStructureId, structuredContentFolderId]");
		}
	}
