...
public abstract class BaseDataRecordCollectionResourceImpl
	...
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/sites/{siteId}/data-record-collection-permissions")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/sites/{siteId}/data-record-collections")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/sites/{siteId}/data-record-collections/{dataRecordCollectionKey}"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
