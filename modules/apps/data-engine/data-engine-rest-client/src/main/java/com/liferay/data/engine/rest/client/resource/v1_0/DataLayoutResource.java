...
public interface DataLayoutResource {
	...
	public void postSiteDataLayoutsPageExportBatch(
			Long siteId, String keywords, String sortString, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSiteDataLayoutsPageExportBatchHttpResponse(
	...
	public static class DataLayoutResourceImpl implements DataLayoutResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-layouts/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-layouts/batch");
		...
		public HttpInvoker.HttpResponse deleteDataLayoutBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-layouts/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/sites/{siteId}/data-layouts/export-batch");
