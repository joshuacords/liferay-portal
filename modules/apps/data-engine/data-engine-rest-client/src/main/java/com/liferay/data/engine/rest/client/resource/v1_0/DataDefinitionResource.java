...
public interface DataDefinitionResource {
	...
	public void postSiteDataDefinitionsPageExportBatch(
			Long siteId, String keywords, String sortString, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSiteDataDefinitionsPageExportBatchHttpResponse(
				Long siteId, String keywords, String sortString,
	...
	public void postSiteDataDefinitionBatch(
			Long siteId, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postSiteDataDefinitionBatchHttpResponse(
			Long siteId, String callbackURL, Object object)
		throws Exception;
	...
	public static class DataDefinitionResourceImpl
		...
		public HttpInvoker.HttpResponse deleteDataDefinitionBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-definitions/batch");
		...
		public void postSiteDataDefinitionsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteDataDefinitionsPageExportBatchHttpResponse(
					siteId, keywords, sortString, callbackURL, contentType,
					fieldNames);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/sites/{siteId}/data-definitions/export-batch");
		...
		public void postSiteDataDefinitionBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteDataDefinitionBatchHttpResponse(
