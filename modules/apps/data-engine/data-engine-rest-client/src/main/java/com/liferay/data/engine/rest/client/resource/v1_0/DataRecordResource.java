	...
	public static class DataRecordResourceImpl implements DataRecordResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-records/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-record-collections/{dataRecordCollectionId}/data-records/export-batch");
		...
		public HttpInvoker.HttpResponse deleteDataRecordBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-records/batch");
