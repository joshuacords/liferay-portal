...
public interface DataRecordCollectionResource {
	...
	public void postSiteDataRecordCollectionsPageExportBatch(
			Long siteId, String keywords, String callbackURL,
			String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSiteDataRecordCollectionsPageExportBatchHttpResponse(
				Long siteId, String keywords, String callbackURL,
				String contentType, String fieldNames)
		throws Exception;
	...
	public static class DataRecordCollectionResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-record-collections/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-record-collections/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/data-record-collections/batch");
		...
		public void postSiteDataRecordCollectionsPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteDataRecordCollectionsPageExportBatchHttpResponse(
					siteId, keywords, callbackURL, contentType, fieldNames);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/data-engine/v1.0/sites/{siteId}/data-record-collections/export-batch");
