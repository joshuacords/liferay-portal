...
public abstract class BaseDataListViewResourceTestCase {
	...
	protected Map<String, Map<String, String>>
		...
		createBatchAction.put(
			"href",
			"http://localhost:8080/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-list-views/batch".
				replace(
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.data.engine.rest.dto.v1_0.DataListView.class)) {
