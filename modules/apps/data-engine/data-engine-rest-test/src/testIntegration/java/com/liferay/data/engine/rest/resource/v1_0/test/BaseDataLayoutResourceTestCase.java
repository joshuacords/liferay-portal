...
public abstract class BaseDataLayoutResourceTestCase {
	...
	protected Map<String, Map<String, String>>
		...
		createBatchAction.put(
			"href",
			"http://localhost:8080/o/data-engine/v1.0/data-definitions/{dataDefinitionId}/data-layouts/batch".
				replace(
	...
	public void testGetSiteDataLayoutsPage() throws Exception {
		...
		if (irrelevantSiteId != null) {
			...
			assertValid(
				page,
				testGetSiteDataLayoutsPage_getExpectedActions(
					irrelevantSiteId));
		}
		...
		assertEqualsIgnoringOrder(
			...
			(List<DataLayout>)page.getItems());
		assertValid(
			page, testGetSiteDataLayoutsPage_getExpectedActions(siteId));
	...
	public void testGraphQLGetSiteDataLayoutsPage() throws Exception {
		...
		Assert.assertEquals(2, dataLayoutsJSONObject.getLong("totalCount"));
