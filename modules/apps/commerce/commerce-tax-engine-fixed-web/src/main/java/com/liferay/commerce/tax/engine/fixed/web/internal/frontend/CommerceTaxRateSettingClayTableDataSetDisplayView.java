...
@Component(
	immediate = true,
	property = "commerce.data.set.display.name=" + CommerceTaxRateSettingDataSetConstants.COMMERCE_DATA_SET_KEY_TAX_RATE_SETTING,
...
public class CommerceTaxRateSettingClayTableDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		clayTableSchemaBuilder.addField("rate", "amount");
