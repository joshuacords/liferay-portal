...
@Component(
	immediate = true,
	property = {
		"commerce.data.set.display.name=" + CommerceProductDataSetConstants.COMMERCE_DATA_SET_KEY_PRODUCT_ATTACHMENTS,
		"commerce.data.set.display.name=" + CommerceProductDataSetConstants.COMMERCE_DATA_SET_KEY_PRODUCT_IMAGES
	},
...
public class CommerceProductMediaClayTableDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		ClayTableSchemaField titleField = clayTableSchemaBuilder.addField(
			"title", "title");

		titleField.setContentRenderer("actionLink");

		clayTableSchemaBuilder.addField("extension", "extension");
