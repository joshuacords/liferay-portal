...
@Component(
	immediate = true,
	property = "commerce.data.set.display.name=" + CommercePricingDataSetConstants.COMMERCE_DATA_SET_KEY_PRICING_CLASSES_PRODUCT_DEFINITIONS,
	service = ClayDataSetDisplayView.class
)
public class CommercePricingClassCPDefinitionRelClayTableDataSetDisplayView
