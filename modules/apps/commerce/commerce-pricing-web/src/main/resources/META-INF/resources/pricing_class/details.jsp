		...
		<div class="col-12">
			...
			>
				<div class="col-12 lfr-form-content">
					<aui:input bean="<%= commercePricingClass %>" disabled="<%= !commercePricingClassDisplayContext.hasPermission(ActionKeys.UPDATE) %>" model="<%= CommercePricingClass.class %>" name="title" required="<%= true %>" />
