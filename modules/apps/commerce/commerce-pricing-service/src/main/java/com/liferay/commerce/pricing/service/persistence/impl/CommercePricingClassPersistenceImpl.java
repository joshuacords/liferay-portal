...
public class CommercePricingClassPersistenceImpl
	...
	public void cacheResult(CommercePricingClass commercePricingClass) {
		entityCache.putResult(
			CommercePricingClassModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache(CommercePricingClass commercePricingClass) {
		...
		clearUniqueFindersCache(
			(CommercePricingClassModelImpl)commercePricingClass, true);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((commercePricingClassModelImpl.getColumnBitmask() &
			 _finderPathFetchByC_ERC.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				commercePricingClassModelImpl.getOriginalCompanyId(),
				commercePricingClassModelImpl.getOriginalExternalReferenceCode()
			};
	...
	public CommercePricingClass updateImpl(
		...
		if (!CommercePricingClassModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {
				commercePricingClassModelImpl.getUuid()
			};
			...
			args = new Object[] {commercePricingClassModelImpl.getCompanyId()};
			...
			if ((commercePricingClassModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					commercePricingClassModelImpl.getOriginalUuid()
				};
				...
				args = new Object[] {commercePricingClassModelImpl.getUuid()};
		...
		entityCache.putResult(
			CommercePricingClassModelImpl.ENTITY_CACHE_ENABLED,
			CommercePricingClassImpl.class,
			commercePricingClass.getPrimaryKey(), commercePricingClass, false);

		clearUniqueFindersCache(commercePricingClassModelImpl, false);
		...
		if (commercePricingClass == null) {
			...
			try {
				...
				if (commercePricingClass != null) {
					...
					entityCache.putResult(
						CommercePricingClassModelImpl.ENTITY_CACHE_ENABLED,
						CommercePricingClassImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception exception) {
				entityCache.removeResult(
	...
	public Map<Serializable, CommercePricingClass> fetchByPrimaryKeys(
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (CommercePricingClass)serializable);
				}
			}
		}
		...
		sb.append(_SQL_SELECT_COMMERCEPRICINGCLASS_WHERE_PKS_IN);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			CommercePricingClassModelImpl.ENTITY_CACHE_ENABLED,
			CommercePricingClassModelImpl.FINDER_CACHE_ENABLED,
			CommercePricingClassImpl.class,
		...
		_finderPathCountAll = new FinderPath(
			CommercePricingClassModelImpl.ENTITY_CACHE_ENABLED,
			CommercePricingClassModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			CommercePricingClassModelImpl.UUID_COLUMN_BITMASK |
			CommercePricingClassModelImpl.CREATEDATE_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			CommercePricingClassModelImpl.UUID_COLUMN_BITMASK |
			CommercePricingClassModelImpl.COMPANYID_COLUMN_BITMASK |
			CommercePricingClassModelImpl.CREATEDATE_COLUMN_BITMASK);
		...
		_finderPathFetchByC_ERC = new FinderPath(
			CommercePricingClassModelImpl.ENTITY_CACHE_ENABLED,
			CommercePricingClassModelImpl.FINDER_CACHE_ENABLED,
			CommercePricingClassImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_ERC",
			new String[] {Long.class.getName(), String.class.getName()},
			CommercePricingClassModelImpl.COMPANYID_COLUMN_BITMASK |
			CommercePricingClassModelImpl.EXTERNALREFERENCECODE_COLUMN_BITMASK);
	...
	private static final String _SQL_SELECT_COMMERCEPRICINGCLASS_WHERE_PKS_IN =
		"SELECT commercePricingClass FROM CommercePricingClass commercePricingClass WHERE commercePricingClassId IN (";
