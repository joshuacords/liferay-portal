 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ProductVirtualSettingsFileEntry",
	service = ProductVirtualSettingsFileEntryResource.Factory.class
)
@Generated("")
public class ProductVirtualSettingsFileEntryResourceFactoryImpl
	implements ProductVirtualSettingsFileEntryResource.Factory {

	@Override
	public ProductVirtualSettingsFileEntryResource.Builder create() {
		return new ProductVirtualSettingsFileEntryResource.Builder() {
			...
			public ProductVirtualSettingsFileEntryResource build() {
				...
				Function
					<InvocationHandler, ProductVirtualSettingsFileEntryResource>
						productVirtualSettingsFileEntryResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_productVirtualSettingsFileEntryResourceProxyProviderFunction;

				return productVirtualSettingsFileEntryResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ProductVirtualSettingsFileEntryResource.Builder
			...
			@Override
			public ProductVirtualSettingsFileEntryResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ProductVirtualSettingsFileEntryResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductVirtualSettingsFileEntryResource.class.getClassLoader(),
			ProductVirtualSettingsFileEntryResource.class);

		try {
			Constructor<ProductVirtualSettingsFileEntryResource> constructor =
				(Constructor<ProductVirtualSettingsFileEntryResource>)
