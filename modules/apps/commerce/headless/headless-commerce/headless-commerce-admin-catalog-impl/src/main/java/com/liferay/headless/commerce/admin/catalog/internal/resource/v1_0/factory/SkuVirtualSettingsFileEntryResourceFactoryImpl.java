 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/SkuVirtualSettingsFileEntry",
	service = SkuVirtualSettingsFileEntryResource.Factory.class
)
@Generated("")
public class SkuVirtualSettingsFileEntryResourceFactoryImpl
	implements SkuVirtualSettingsFileEntryResource.Factory {

	@Override
	public SkuVirtualSettingsFileEntryResource.Builder create() {
		return new SkuVirtualSettingsFileEntryResource.Builder() {
			...
			public SkuVirtualSettingsFileEntryResource build() {
				...
				Function<InvocationHandler, SkuVirtualSettingsFileEntryResource>
					skuVirtualSettingsFileEntryResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_skuVirtualSettingsFileEntryResourceProxyProviderFunction;

				return skuVirtualSettingsFileEntryResourceProxyProviderFunction.
					apply(
			...
			@Override
			public SkuVirtualSettingsFileEntryResource.Builder checkPermissions(
			...
			@Override
			public SkuVirtualSettingsFileEntryResource.Builder
			...
			@Override
			public SkuVirtualSettingsFileEntryResource.Builder preferredLocale(
			...
			@Override
			public SkuVirtualSettingsFileEntryResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public SkuVirtualSettingsFileEntryResource.Builder user(User user) {
				_user = user;
	...
	private static Function
		<InvocationHandler, SkuVirtualSettingsFileEntryResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SkuVirtualSettingsFileEntryResource.class.getClassLoader(),
			SkuVirtualSettingsFileEntryResource.class);

		try {
			Constructor<SkuVirtualSettingsFileEntryResource> constructor =
				(Constructor<SkuVirtualSettingsFileEntryResource>)
