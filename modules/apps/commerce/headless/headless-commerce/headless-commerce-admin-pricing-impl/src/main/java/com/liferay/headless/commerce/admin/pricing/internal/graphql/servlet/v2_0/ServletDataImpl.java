			...
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					...
					put(
						"query#discountIdAccount",
						new ObjectValuePair<>(
							AccountResourceImpl.class, "getDiscountIdAccount"));
					put(
						"query#priceListIdAccount",
						new ObjectValuePair<>(
							AccountResourceImpl.class,
							"getPriceListIdAccount"));
					put(
						"query#discountIdAccountGroup",
						new ObjectValuePair<>(
							AccountGroupResourceImpl.class,
							"getDiscountIdAccountGroup"));
					put(
						"query#priceListIdAccountGroup",
						new ObjectValuePair<>(
							AccountGroupResourceImpl.class,
							"getPriceListIdAccountGroup"));
					put(
						"query#discountIdCategoryPage",
						new ObjectValuePair<>(
							CategoryResourceImpl.class,
							"getDiscountIdCategoryPage"));
					put(
						"query#priceModifierIdCategory",
						new ObjectValuePair<>(
							CategoryResourceImpl.class,
							"getPriceModifierIdCategory"));
					put(
						"query#discountIdChannel",
						new ObjectValuePair<>(
							ChannelResourceImpl.class, "getDiscountIdChannel"));
					put(
						"query#priceListIdChannel",
						new ObjectValuePair<>(
							ChannelResourceImpl.class,
							"getPriceListIdChannel"));
					put(
						"query#discounts",
						new ObjectValuePair<>(
					...
					put(
						"query#discountIdProductPage",
						new ObjectValuePair<>(
							ProductResourceImpl.class,
							"getDiscountIdProductPage"));
					put(
					...
					put(
						"query#priceModifierIdProduct",
						new ObjectValuePair<>(
							ProductResourceImpl.class,
							"getPriceModifierIdProduct"));
					put(
						"query#discountIdProductGroupPage",
						new ObjectValuePair<>(
							ProductGroupResourceImpl.class,
							"getDiscountIdProductGroupPage"));
					put(
						"query#priceModifierIdProductGroup",
						new ObjectValuePair<>(
							ProductGroupResourceImpl.class,
							"getPriceModifierIdProductGroup"));
					put(
