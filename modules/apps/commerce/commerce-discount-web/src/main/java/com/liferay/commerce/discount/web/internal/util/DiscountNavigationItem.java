...
@Component(
	immediate = true,
	property = {
		"commerce.pricing.navigation.item.key=" + CommerceDiscountPortletKeys.COMMERCE_DISCOUNT,
...
public class DiscountNavigationItem implements PricingNavigationItem {
	...
	public NavigationItem getNavigationItem(PortletRequest portletRequest)
		...
		navigationItem.setActive(
			portletId.equals(CommerceDiscountPortletKeys.COMMERCE_DISCOUNT));

		PortletURL portletURL = _portal.getControlPanelPortletURL(
			portletRequest, CommerceDiscountPortletKeys.COMMERCE_DISCOUNT,
