...
public abstract class CommerceRegionServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommerceRegionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommerceRegionServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(commerceRegionService);
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = CommerceRegionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, commerceRegionService);
		}
